...
SECRET_KEY = "2e#s6f@240m=*eq$dbgn!x6=!=tyzxl4t4n_ti!0ujq1m*zwp3_v0^rsa5j(0q@ud1953b$"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'bia_lona_antincendios'),
        'USER': os.environ.get('DB_USER', 'bia_bombero'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'bia_bombero'),
