...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0005_alter_automaticcollectioncriteria_condition_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='automaticcollectioncriteria',
            name='reference',
            field=models.CharField(default='NAW2022112236629677f5', max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='reference',
            field=models.CharField(default='YB1790E3410B01', max_length=30),
        ),
    ]
