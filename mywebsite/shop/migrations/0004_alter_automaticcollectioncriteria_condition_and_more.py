...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0003_alter_automaticcollectioncriteria_condition_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='automaticcollectioncriteria',
            name='reference',
            field=models.CharField(default='NAW20221122943c97885c', max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='reference',
            field=models.CharField(default='ML432014F3B12D', max_length=30),
        ),
    ]
