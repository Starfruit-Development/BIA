...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0002_alter_automaticcollectioncriteria_condition_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='automaticcollectioncriteria',
            name='reference',
            field=models.CharField(default='NAW202211217a844cceb4', max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='reference',
            field=models.CharField(default='ZF7103F83DAAE2', max_length=30),
        ),
    ]
