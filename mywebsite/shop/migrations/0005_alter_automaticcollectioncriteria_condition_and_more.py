...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0004_alter_automaticcollectioncriteria_condition_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='automaticcollectioncriteria',
            name='reference',
            field=models.CharField(default='NAW20221122bd24f56ebf', max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='reference',
            field=models.CharField(default='TD45518E343DA8', max_length=30),
        ),
    ]
